...
class TestBooksCollector:
    ...
    def test_set_book_genre_invalid_names_and_genre_not_added(self, name, genre):
        collector = BooksCollector()
        collector.add_new_book('Гордость и предубеждение и зомби')
        collector.set_book_genre(name, genre)
        assert collector.get_books_genre().get(name) != genre

    def test_set_book_genre_valid_data_genre_added(self):
        collector = BooksCollector()
        collector.add_new_book('Гордость и предубеждение и зомби')
    ...
    def test_get_books_with_specific_genre_invalid_genre_returns_empty_list(self, genre):
        collector = BooksCollector()
        collector.add_new_book('Оно')
        collector.set_book_genre('Оно', 'Ужасы')
        assert collector.get_books_with_specific_genre(genre) == []

    def test_get_books_with_specific_genre_existing_genre_without_books_returns_empty_list(self):
        collector = BooksCollector()
